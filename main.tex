...
The vertex  $\vec{B}$ can  be expressed  in {\em polar coordinate form} as
%\label{prob:tri_polar}
\begin{align}
\vec{B} = c\myvec{\cos \theta\\  \sin \theta} 
\end{align}
...
\\
sin B = \sqrt{1-(0.675)^2}
\\
sin B = 0.737817728168
\\
where 
\\
c = \sqrt{a^2+b^2} = \sqrt{41}
\\
c = 6.403124237432
\\
$\vec{B}  can  be   expressed  as
\vec{B} = c\myvec{\ cos B \\ \ sin  B}

\\
\vec{B} = \myvec{\ 4.322108860267 \\ \ 4.724338578040}
\end{align}
So,the vertices of $\triangle ABC$ in fig. 
\begin{align}
\vec{A} = \myvec{3.375\\4.960}, \vec{B} = \myvec{4.322\\4.724}, \vec{C} = \myvec{4\\0}
\end{align}
